...
bool DecodeBase58(const char* psz, std::vector<unsigned char>& vch)
{
    ...
    std::vector<unsigned char>::iterator it = b256.begin() + static_cast<ptrdiff_t>(size - size_t(length));
...
std::string EncodeBase58(const unsigned char* pbegin, const unsigned char* pend)
{
    ...
    std::vector<unsigned char>::iterator it = b58.begin() + static_cast<ptrdiff_t>(size - size_t(length));
